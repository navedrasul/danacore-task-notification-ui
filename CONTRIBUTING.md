# Contributing to DanaCore Task Notification App UI

First off, thanks for taking the time to contribute! The following is a set of guidelines for contributing to DanaCore Task Notification App UI.
...
We strive to foster a positive and inclusive community. Please be respectful and follow our [Code of Conduct](https://github.com/navedrasul/danacore-task-notification-ui/blob/main/CODE_OF_CONDUCT.md).

Thank you for your contributions! Together, we can make DanaCore Task Notification App UI better for everyone.
